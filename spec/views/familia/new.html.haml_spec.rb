...
describe "familia/new.html.haml" do
  before(:each) do
    assign(:familium, stub_model(Familium,
      :nis => "MyString",
      :logradouro => "MyString",
      :numero => "MyString",
  ...
  it "renders new familium form" do
    render

    # Run the generator again with the --webrat flag if you want to use webrat matchers
    assert_select "form", :action => familia_path, :method => "post" do
